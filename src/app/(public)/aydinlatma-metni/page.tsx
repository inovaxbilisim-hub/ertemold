...
const pageId = 'kvkk'; // Aydinlatma metni content is stored under 'kvkk' ID in this system
...
export default async function LegalPage() {
  ...
  return (
    <main className="bg-[#fbfcff] min-h-screen pt-40 pb-32 px-6">
      <StructuredData id={`${pageId}-schema`} data={aydinlatmaSchemas} />
