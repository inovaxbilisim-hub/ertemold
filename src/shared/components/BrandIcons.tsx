...
export const Facebook = ({ size = 24, strokeWidth = 2, ...props }: BrandIconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const Instagram = ({ size = 24, strokeWidth = 2, ...props }: BrandIconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const Linkedin = ({ size = 24, strokeWidth = 2, ...props }: BrandIconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const Youtube = ({ size = 24, strokeWidth = 2, ...props }: BrandIconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const Twitter = ({ size = 24, strokeWidth = 2, ...props }: BrandIconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
